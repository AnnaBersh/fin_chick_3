...
import '../../../core/constants/daily_bonus.dart';
import '../../../data/datasources/local/storage_service.dart';
import 'event.dart';
import 'state.dart';

class BonusBloc extends Bloc<DailyBonusEvent, DailyBonusState> {
  final StorageService storage;

  BonusBloc({required this.storage}) : super(const DailyBonusState()) {
