  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(AppTexts.statistic, style: AppStyles.titleAppBarYel),
        actions: [
          IconButton(
            onPressed: () =>
                  ...
                  if (_total <= 0)
                    Expanded(
                      child: Center(
                        child: Text(
                          AppTexts.noData,
                          style: AppStyles.mediumYel.copyWith(fontSize: 18),
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Expanded(
                                    child: Text(
                                      item.name,
                                      style: AppStyles.statListWhite.copyWith(fontSize: 16),
                                      overflow: TextOverflow.ellipsis,
                                    ),
                                  ),
                                  Text('$percent%', style: AppStyles.statListWhite),
                                ],
                              ),
                            );
                          },
