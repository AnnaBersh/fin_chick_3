...
import 'package:itd_2/presentation/screens/settings/view/settings_screen.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(AppTexts.privacy, style: AppStyles.titleAppBarYel),
        leading: IconButton(
          onPressed: () =>
        ...
        child: Center(
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(color: AppColors.topYellow80, width: 5),
            ),
            child: ClipRRect(
              borderRadius: BorderRadius.circular(20),
              child: InAppWebView(
